"""
Django settings for demo_46722 project.
...
WSGI_APPLICATION = 'demo_46722.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_46722 API",
    "DESCRIPTION": "API documentation for demo_46722 App",
    "VERSION": "v1",
}
